...
def solve():
    ...
    hello = os.path.abspath(os.path.join(os.path.dirname(
        __file__), "..", "Problems", "ProblemSetList.txt"))
    r = open(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "Problems", "ProblemSetList.txt")))
    ...
    with open(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "Results", "AgentAnswers.csv")), "w") as results:
